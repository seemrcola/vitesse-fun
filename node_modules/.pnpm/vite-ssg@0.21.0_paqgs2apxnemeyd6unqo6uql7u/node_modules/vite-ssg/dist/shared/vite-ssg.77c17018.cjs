...
const state = require('./vite-ssg.522c2439.cjs');
...
async function build(ssgOptions = {}, viteConfig = {}) {
  ...
  const _require = module$1.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('shared/vite-ssg.77c17018.cjs', document.baseURI).href)));
